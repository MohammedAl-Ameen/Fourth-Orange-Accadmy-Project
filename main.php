...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  echo '<tr>';
  echo '<td scope="row">' .$_SESSION["phone"][$i]["model"] .'</td>';
  echo '<td scope="row">' .$_SESSION["phone"][$i]["brand"] .'</td>';
  echo '<td scope="row">' .$_SESSION["phone"][$i]["color"] .'</td>';
  echo '<td scope="row">' .$_SESSION["phone"][$i]["description"] .'</td>';
  echo '<td scope="row">' .$_SESSION["phone"][$i]["price"] .'</td>';
  echo '</tr>';
  }
  echo "</table>";
  echo "</div>";
